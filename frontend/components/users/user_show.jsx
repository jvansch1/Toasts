...
class UserShow extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchUser(this.props.routeParams.userId)
      ...
      .then(() => this.props.topUserBeers(this.props.routeParams.userId).then(() => this.setState({mounted: true, loaded: true})))
  ...
  render() {
    if ((!this.state.mounted) || (!this.props.user && this.props.checkins && this.props.query)) {
      return (
        <div>
          {this.renderSpinner()}
        </div>
